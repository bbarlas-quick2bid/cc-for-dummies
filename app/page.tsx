...
const tools = [
  { name: "VSCode", role: "Code editor", color: "text-blue-600" },
  { name: "Claude Code", role: "AI coding assistant", color: "text-brand-500" },
  { name: "GitHub", role: "Version control + hosting", color: "text-slate-700" },
  { name: "Vercel", role: "Deploy in seconds", color: "text-slate-900" },
];
      ...
      <section className="bg-brand-500 text-white">
        <div className="max-w-4xl mx-auto px-6 pt-20 pb-20 text-center">
          ...
          <p className="text-xl text-brand-100 leading-relaxed max-w-2xl mx-auto mb-4">
            <em className="font-semibold not-italic text-white">Smart Quotes for Complex Deals</em>
            {" "}— and smart tools for the developers who build them.
          </p>
          <p className="text-brand-200 leading-relaxed max-w-2xl mx-auto mb-10">
        ...
        <div className="rounded-2xl border border-brand-100 bg-brand-50 p-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6 text-sm text-slate-500">
            <div>
              ...
              <p className="font-semibold text-brand-500 mb-1">Read the explainer</p>
              <p>
            ...
            <div>
              <div className="text-2xl mb-2">🤖</div>
              <p className="font-semibold text-brand-500 mb-1">Copy the AI prompt</p>
              <p>
